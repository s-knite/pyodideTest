...
try:
    # --- Global Variables ---
    tester.check_variable_exists("stations")
    ...
    if tester.confirm_function_exists("get_station") and tester.confirm_variable_exists("stations"):
        # First try
        ...
        tester.include_result("Testing function get_station with inputs ['Brixton']. (Skipped - missing function or 'stations' variable)", SKIPPED)
        tester.include_result("Testing function get_station with inputs ['V', 'Vaux', 'Vauxhall']. (Skipped - missing function or 'stations' variable)", SKIPPED)
        tester.include_result("Testing function get_station with inputs [... 'Oxford Circus']. (Skipped - missing function or 'stations' variable)", SKIPPED)
    ...
    if tester.confirm_function_exists("calculate_stops") and tester.confirm_variable_exists("stations"):
        ...
        tester.include_result("Testing function calculate_stops using arguments [['Stockwell', 'Oxford Circus']]. (Skipped - missing function or 'stations' variable)", SKIPPED)
        tester.include_result("Testing function calculate_stops using arguments [['Brixton', 'Walthamstow Central']]. (Skipped - missing function or 'stations' variable)", SKIPPED)
        tester.include_result("Testing function calculate_stops using arguments [['Oxford Circus', 'Stockwell']]. (Skipped - missing function or 'stations' variable)", SKIPPED)
        tester.include_result("Testing function calculate_stops using arguments [['Seven Sisters', 'Victoria']]. (Skipped - missing function or 'stations' variable)", SKIPPED)
